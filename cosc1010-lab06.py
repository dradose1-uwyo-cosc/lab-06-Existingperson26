...
for char in random_string:
    sortedLetters.append(char)
sortedLetters.sort()

headache2 = {}
for letter2 in sortedLetters:
    if letter2 not in headache2:
        headache2[letter2] = 1
    else:
        headache2[letter2] += 1
print(headache2)
...
storedVal = 0
most_occurred = 0
for key, value in headache.items():
    if storedVal < value:
        storedVal = value
        most_occurred = key

maximumVal = storedVal
storedMin = 0
print(maximumVal)
for key, value in headache.items():
    if maximumVal > value:
...
for key, value in headache2.items():
    print(f"Percentage Occurrence: {value / len(random_string) * 100})%")
